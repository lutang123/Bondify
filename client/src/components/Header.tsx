        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="font-medium text-gray-700 hover:text-[hsl(var(--lovers))] transition-colors">
                Categories
          ...
          <Link href="/about" className={`font-medium ${location === "/about" ? "text-purple-600" : "text-gray-700 hover:text-purple-600"} transition-colors`}>
              About
          </Link>
          
          <Link href="/join-club" className="font-medium px-5 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:shadow-md transition-all">
              Join Bondify Club
          </Link>
        </nav>
      ...
      {mobileMenuOpen && (
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/join-club" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-gradient-to-r from-purple-600 to-pink-600">
              Join Bondify Club
            </Link>
          </div>
        </motion.div>
