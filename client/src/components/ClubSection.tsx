            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link href="/join-club" className="w-full sm:w-auto px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white text-center font-medium hover:shadow-md transition-all">
